<template>
  <div
    class="bg-white w-[292px]d min-w-[292px] m-xl:w-[280px]d m-xl:min-w-[280px] h-[406px] m-xl:h-[370px] p-6 pb-8 rounded-[10px] flex flex-col justify-between card-shadow"
  >
    ...
    <div class="flex flex-col justify-center gap-6 rounded-md">
      ...
      <div class="skeleton h-6 w-52 rounded-md"></div>
