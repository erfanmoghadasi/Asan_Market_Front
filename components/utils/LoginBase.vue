<template>
  ...
  >
    <div class="w-full h-full min-h-[540px] flex justify-center items-center p-16">
      <!-- ---------------------RIGHT SIDE-------------------- -->
      <div class="relative w-1/2 h-full min-h-[540px] flex items-center justify-between">
        ...
        >
          ...
          <div :class='stepperBgHandler'>
            <div :class=" pageNumber >= 1 ?  'current-step-dot' : 'disable-step-dot'  "></div>
            <div :class=" pageNumber >= 2 ?  'current-step-dot' : 'disable-step-dot'  "></div>
            <div :class=" pageNumber >= 3 ?  'current-step-dot' : 'disable-step-dot'  "></div>
            <div :class=" pageNumber >= 4 ?  'current-step-dot' : 'disable-step-dot'  "></div>
          </div>
        ...
        <!-- -----------LOGO-------------- -->
        <div class="">
          <NuxtIcon :name='props.headerInfo.iconName' class="text-[141px]" filled />
        </div>
        <!-- -----------TEXT-------------- -->
        <div class="pr-6">
          <h6 class="text-gray-b5 text-6 font-black">{{ headerInfo.header }}</h6>
