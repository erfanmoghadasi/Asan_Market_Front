<template>
  <div
    class="bg-white cursor-pointer select-none w-[292px]z min-w-[292px] m-xl:w-[280px]z m-xl:min-w-[280px]  h-[406px] p-6 pb-8 rounded-[10px] flex flex-col justify-between card-shadow"
  >
