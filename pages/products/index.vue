<template>
    ...
    <div class="w-full pt-28 pb-24 flex">
       <ProductsSidebarFilter />
        ...
        <div class="grow">
            <!-- ------------------------------ SORTING -------------------------- -->
            <div class="grow ml-6 pb-4 mb-10 font-bold text-[#999999] flex items-center gap-4 border-b-2 border-[#EBEBEB]">
...
<script setup lang="ts">
    ...
    const handleSort = (e :any) => {
        sortBy.value.forEach(p => {
            p.isClicked = false;
            p.title === e.target.innerText ? p.isClicked = true : p.isClicked = false;
        })
    }
