<template>
    <div class="w-full min-h-fit pt-[145px]">
        <div class="w-full max-w-[1558px] mb-32 mx-auto ">

            <div class="relative flex w-full items-center justify-start gap-14 pb-7 mb-6 border-b-2 border-gray-b7">
                <button
                    @click="tab = false"
                    :class="!tab ? 'text-primary-orginal' : ' text-gray-b5'"
                class="font-medium   flex items-center text-2xl  justify-center gap-3">
                    <span>سبد خرید</span>
                    <span class="w-8 h-8 bg-gray-b8 rounded text-base grid items-center ">10</span>
                </button>
                <button
                    @click="tab = true"
                    :class="tab ? 'text-primary-orginal' : ' text-gray-b5'"
                class="font-medium  flex items-center  text-2xl justify-center gap-3">
                    <span>خرید قبلی</span>
                    <span class="w-8 h-8 bg-gray-b8 rounded text-base grid items-center ">3</span>
                </button>
            ...
            <div class="flex gap-6 w-full">
                <div class="grow border-2 border-gray-b7 rounded-[10px] overflow-hidden">
                    <FactorProductBill v-for="item in selectedBill" :image="item.image" :key="item.image" />
                </div>
                <div class="w-[450px] h-[400px] flex flex-col justify-between p-6 rounded-[10px] bg-gray-b9 border-2 border-gray-b7">
                    ...
                    <button class="c-btn w-full bg-primary-orginal text-white font-bold text-xl">ثبت و مشاهده پیش فاکتور</button>
                </div>
            </div>
        </div>
    </div>
